...
## Results
(We have not yet performed any tests, but we will be doing tests in the coming weeks for which we will show results in future reports).

## Analysis
(We have not yet performed any tests, but we will be doing tests in the coming weeks for which we will show analysis in future reports).

## Conclusions
(We have not yet performed any tests, but we will be doing tests in the coming weeks for which we will show conclusions in future reports).

## Future Work
(At this point in time, 'Future Work' will consist of our plans for the rest of the semester).
HRS: Plate Settlers' next steps include performing baseline tests with the plate settlers apparatus, which will be 3D-printed. PVC plates will inserted into the slots at a 45 degree angle initially. Following observation of these results, HRS: PS will perform subsequent experiments to determine how the effluent turbidity varies with changes in angle of the plates orientation, as well as with the alteration of variables such as number of plates, spacing of plates, and thicknesses of plates.

**[Lit review and previous work should be right after abstract]**
