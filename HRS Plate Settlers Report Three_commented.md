...
In order to ensure floc blanket stability, the team proposes 45&deg; to be the ideal plate-angle. This is operating under the hypothesis that plate settlers follow the principles that govern particle capture in a tube settler. Henceforth, based on the Figure 3, angle $\alpha$ is 45&deg;, because this maximizes the distance the floc travels, and that enables an even distribution and long creation of the floc blanket.
...
**Figure 4. Printed design placed inside the testing-tank.**
